...
# ## Test Uni-directional LSTM using Keras with Tensorflow Backend
...
get_ipython().system(u'mkdir BC5')
get_ipython().system(u'cp "Location of train.txt" BC5')
get_ipython().system(u'cp "Location of test.txt" BC5')
get_ipython().system(u'cp "Location of evaluation script" BC5')
get_ipython().system(u'chmod 777 BC5/evalbc5.pl')
get_ipython().system(u'ls BC5')
...
TRAIN_FILEPATH = "BC5//train_bc5.txt"
TEST_FILEPATH = "BC5//test_bc5.txt"
...
if __name__ == "__main__":
    ...
    X_train, Y_train, X_test, Y_test, unkwords = reader.get_data()
    print(X_train.shape)
    print(Y_train.shape)
    print(X_test.shape)
    print(Y_test.shape)
...
file2 = open("BC5//test_bc5.txt")
target = open("BC5//eval2.txt", "w")
...
get_ipython().system(u'./BC5/evalbc5.pl BC5/eval2.txt BC5/test_bc5.txt')
