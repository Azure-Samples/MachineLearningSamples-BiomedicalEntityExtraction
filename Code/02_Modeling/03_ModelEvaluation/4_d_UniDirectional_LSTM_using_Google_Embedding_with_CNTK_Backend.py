...
# ## Test Uni-directional LSTM with Generic Embeddings using Keras with CNTK Backend
...
get_ipython().system(u'mkdir BC2')
get_ipython().system(u'cp "Location of train.txt" BC2')
get_ipython().system(u'cp "Location of test.txt" BC2')
get_ipython().system(u'cp "Location of evaluation script" BC2')
get_ipython().system(u'chmod 777 BC2/evalBC2.pl')
get_ipython().system(u'ls BC2')
...
get_ipython().system(u'./BC2/evalBC2.pl BC2/eval2_g.txt BC2/BC2_test.txt')
